<div style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; line-height: 1.6;">
  ...
  <p style="font-size: 0.98rem; max-width: 920px; margin: 0.2rem auto 0;">
    A Java simulation and visualization project for a <strong>3-DOF, two-link manipulator</strong> with a <strong>fixed base</strong> in 3D space.
  ...
  <ul style="max-width: 920px; margin: 0.5rem auto 0.2rem; padding-left: 1.2rem;">
    ...
    <li><strong>Visualization:</strong> rendered with <strong>raylib</strong> via <strong>Jaylib</strong>, including an overlay panel and a simple suction-tool “ball” pick-and-place animation.</li>
  </ul>
...
The Jaylib Gradle dependency is documented in the Jaylib repository.
### Build commands
...
- Some macOS configurations require starting Java on the first thread. If you see a startup error, run with:
  ...
  ```
  The Jaylib README documents this flag for macOS.
